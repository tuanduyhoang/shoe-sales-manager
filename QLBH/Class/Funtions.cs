...
{    class Functions
        {
            ...
            public static void Connect()
            {
                ...
                Con.ConnectionString = @"Data Source=DUYHOANG;Initial Catalog=QLBH;Integrated Security=True";
                Con.Open();                  //Mở kết nối
                                             //Kiểm tra kết nối
                if (Con.State == ConnectionState.Open)

                    MessageBox.Show("Kết lối thành công", "xin chào DUY HOÀNG");
                else MessageBox.Show("Không thể kết nối với dữ liệu");

            }
        private static string stringConnection = @"Data Source=DUYHOANG;Initial Catalog=QLBH;Integrated Security=True";
