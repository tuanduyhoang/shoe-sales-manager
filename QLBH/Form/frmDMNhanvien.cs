...
namespace QLBH
{
    public partial class frmDMNhanvien : Form
    {
        ...
        public void LoadDataGridView()
        {
            ...
            dgvNhanVien.Columns[5].HeaderText = "Tuổi";
        ...
        private void dgvNhanVien_Click(object sender, EventArgs e)
        {
            ...
            if (dgvNhanVien.CurrentRow.Cells["sGioiTinh"].Value.ToString() == "Nam") chkGioiTinh.Checked = true;
            else chkGioiTinh.Checked = false;
            txtDiaChi.Text = dgvNhanVien.CurrentRow.Cells["sDiaChi"].Value.ToString();
            mtbDienThoai.Text = dgvNhanVien.CurrentRow.Cells["sDienThoai"].Value.ToString();
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (dtpNgaySinh.Text == " ")
            {
                MessageBox.Show("Bạn phải nhập tuổi", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                dtpNgaySinh.Focus();
                return;
            }
            ...
            if (chkGioiTinh.Checked == true || chkGioiTinh.Checked == false)
                gt = "Nam";
            ...
            sql = "INSERT INTO tblNhanVien(sMaNhanVien,sTenNhanVien,sGioiTinh, sDiaChi,sDienThoai, dNgaySinh) VALUES (N'" + txtMaNhanVien.Text.Trim() + "',N'" + txtTenNhanVien.Text.Trim() + "',N'" + gt + "',N'" + txtDiaChi.Text.Trim() + "','" + mtbDienThoai.Text + "','" + Functions.ConvertDateTime(dtpNgaySinh.Text) + "')";
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE tblNhanVien SET  sTenNhanVien=N'" + txtTenNhanVien.Text.Trim().ToString() +
                    ...
                    "',sDienThoai='" + mtbDienThoai.Text.ToString() + "',sGioiTinh=N'" + gt +
                    "',dNgaySinh='" + Functions.ConvertDateTime(dtpNgaySinh.Text) +
        ...
        {
            crNhanVien crnv = new crNhanVien();
            crnv.ShowDialog();
        }
    }
}
