    ...
    public partial class frmDMKhachHang : Form
    {
       private DataTable tblKH; //Bảng khách hàng
        ...
        private void dgvKhachHang_Click(object sender, EventArgs e)
        {
            ...
            txtMaKhach.Text = dgvKhachHang.CurrentRow.Cells["sMaKhachHang"].Value.ToString();
            txtTenKhach.Text = dgvKhachHang.CurrentRow.Cells["sTenKhachHang"].Value.ToString();
            txtDiaChi.Text = dgvKhachHang.CurrentRow.Cells["sDiaChi"].Value.ToString();
            mtbDienThoai.Text = dgvKhachHang.CurrentRow.Cells["sDienThoai"].Value.ToString();
            btnSua.Enabled = true;
            btnXoa.Enabled = true;
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE tblKhachHang SET sTenKhachHang=N'" + txtTenKhach.Text.Trim().ToString() + "',sDiaChi=N'" +
                txtDiaChi.Text.Trim().ToString() + "',sDienThoai='" + mtbDienThoai.Text.ToString() +
                "' WHERE sMaKhachHang=N'" + txtMaKhach.Text + "'";
            Functions.RunSQL(sql);
            LoadDataGridView();
            ResetValues();
            btnBoQua.Enabled = false;
