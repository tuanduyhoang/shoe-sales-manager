...
using QLBH.Class; //Sử dụng class Functions.cs
...
namespace QLBH
{
    public partial class frmDMChatLieu : Form
    {
        ...
        private void dgvChatLieu_Click(object sender, EventArgs e)
        {
            ...
            txtMaChatLieu.Text = dgvChatLieu.CurrentRow.Cells["sMaChatLieu"].Value.ToString();
            txtTenChatLieu.Text = dgvChatLieu.CurrentRow.Cells["sTenChatLieu"].Value.ToString();
            btnSua.Enabled = true;
            btnXoa.Enabled = true;
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE tblChatLieu SET sTenChatLieu=N'" +
                txtTenChatLieu.Text.ToString() +
                "' WHERE sMaChatLieu=N'" + txtMaChatLieu.Text + "'";
